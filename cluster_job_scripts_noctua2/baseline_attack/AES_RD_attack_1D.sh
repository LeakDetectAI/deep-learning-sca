declare -a dataset_array=("AES_RD")
...
declare -a use_tuner_array=("--use_tuner" "--no-use_tuner")
declare -a use_weight_averaging_array=("--weight_averaging" "--no-weight_averaging")
    ...
    do
        ...
        do
          ...
          do
            ...
            do
              sbatch AES_RD_attack_1D_run.sh $dataset $loss $model $dataset_dimension $byte $use_tuner $weight_averaging
            done
          done
        done
    done
