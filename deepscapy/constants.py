...
__all__ = ['CATEGORICAL_CROSSENTROPY_LOSS', 'FOCAL_LOSS_BE', 'FOCAL_LOSS_CE', 'DICE_BCE_LOSS', 'CROSS_ENTROPY_RATIO',
           ...
           'AES_HD', 'AES_RD', 'DP4_CONTEST', 'ASCAD_DATASETS', 'CHES_CTF', 'AES_HDV2', 'AES_HDV2_EXT', 'AES_HDV2_NORM',
           'AES_HDV2_DATASETS', 'HYPERBAND_TUNER', 'RANDOM_TUNER', 'BAYESIAN_TUNER', 'GREEDY_TUNER', 'TUNER_TYPES',
           'MEAN_RANKS', 'QTE_NUM_TRACES', 'SCORES', 'MEAN_RANK_FINAL', 'ACCURACY', 'MIN_COMPLETE_MEAN_RANK',
           'LAST_INDEX_MEAN_RANK', 'MIN_LAST_100_MEAN_RANK', 'NAS_TRIALS_DIRECTORY', 'NAS_TRIALS_DIRECTORY_NEW',
           'TRAINED_MODELS_NON_TUNED', 'TRAINED_MODELS_TUNED', 'TRAINED_MODELS_NAS', 'TRAINED_MODELS_NAS_NEW',
           "RESULTS", "RESULTS_NEW", 'BASELINES', 'TRAINED_MODELS', 'TRAINED_HYPERMODEL', 'HP_TRAINED_MODELS_TUNED',
           'ASCAD_AES_Sbox', 'AES_RD_Sbox', 'AES_Sbox_inv', 'DP4CONTEST_BOX', 'aes_hd_key', 'package_name',
           'NAS_BASIC2', 'NAS_BASIC3', 'NAS_BASIC4', 'NAS_BASIC5', 'TWOD_CNN_RECT', 'TWOD_CNN_SQR', 'ONED_CNN',
           'RESHAPE_TYPES', 'INPUT_SHAPE_DICT', 'MLP', 'TRAINABLE_PARAMS', 'NON_TRAINABLE_PARAMS', 'TOTAL_PARAMS',
           'N_DENSE_LAYERS', 'N_CONV_LAYERS', 'HW', 'ID']
...
AES_HDV2_EXT = 'AES_HDV2EXT'
AES_HDV2_NORM = 'AES_HDV2NORM'
CHES_CTF = 'CHES_CTF'
AES_HD = 'AES_HD'
AES_HDV2 = 'AES_HDV2'
AES_RD = 'AES_RD'
...
AES_HDV2_DATASETS = [AES_HDV2_EXT, AES_HDV2_NORM]
