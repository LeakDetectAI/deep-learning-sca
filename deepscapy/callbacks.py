...
class OneCycleLR(Callback):
    def __init__(self,
        ...
        self.epochs = None
        # Added a parameter batch_size in the function to fix the issue on line 150
        self.batch_size = batch_size
        # Added a parameter samples in the function to fix the issue on line 152
...
class PrintTrialModelCallback(Callback):
    def __init__(self):
        super(Callback, self).__init__()
        self.logger = logging.getLogger(PrintTrialModelCallback.__name__)

    def on_train_end(self, logs=None):
        self.logger.info("---------------- Model summary and performance for current trial ----------------")
        self.model.summary(print_fn=self.logger.info)
        self.logger.info(print_dictionary(dict(logs)))
