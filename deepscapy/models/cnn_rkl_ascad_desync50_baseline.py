...
class CNNRankingLossASCADDesync50Baseline(SCANNModel):
    ...
    def _construct_model_(self, **kwargs):
        ...
        # Logits layer
        score_layer = Dense(self.num_classes, activation=None, name='score_ascad_desync50', **kwargs)(x)
    ...
    def fit(self, X, y, verbose=1, **kwargs):
        return super().fit_lr(X=X, y=y, epochs=50, batch_size=256, verbose=verbose, max_lr=5e-3, **kwargs)
