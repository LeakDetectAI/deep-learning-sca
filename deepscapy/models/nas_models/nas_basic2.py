...
class NASBasic2(NASModel):
    def __init__(self, model_name, num_classes, input_dim, dataset, reshape_type,
        ...
        super(NASBasic2, self).__init__(model_name=model_name, num_classes=num_classes, input_dim=input_dim,
                                        dataset=dataset, loss_function=loss_function,
                                        loss_function_name=loss_function_name, model_directory=NAS_BASIC2,
    ...
    def _construct_model_(self):
        ...
        # Block 1
        x = ConvBlockExt(num_blocks=hp.Choice(name='num_blocks', values=[1, 2]),
