...
from deepscapy.constants import NAS_BASIC3
from deepscapy.core import *
from deepscapy.core import ImageInputExt
from deepscapy.core.extension_blocks import DenseBlockExt


class NASBasic3(NASModel):
    def __init__(self, model_name, num_classes, input_dim, dataset, reshape_type,
        ...
        super(NASBasic3, self).__init__(model_name=model_name, num_classes=num_classes, input_dim=input_dim,
                                        dataset=dataset, loss_function=loss_function,
                                        loss_function_name=loss_function_name, model_directory=NAS_BASIC3,
    ...
    def _construct_model_(self):
        ...
        # Block 1
        x = ConvBlockExt(num_blocks=hp.Choice(name='num_blocks', values=[1, 2, 3]),
